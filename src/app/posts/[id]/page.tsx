...
type postDetailsProps = {params : params}
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-12">
      ...
      <div className="p-12 md:w-1/2 flex flex-col items-start">
        ...
        <h2 className="sm:text-3xl text-2xl title-font font-medium text-cyan-500 mt-4 mb-4">{currentPost.title}</h2>
        <p className="leading-relaxed text-fuchsia-700 mb-8">{currentPost.body}.</p>
        ...
        <a className="inline-flex items-center">
          ...
          <span className="flex-grow flex flex-col pl-4">
            <span className="title-font font-medium text-cyan-500">{currentPost.title}</span>
